...
const fixtures: readonly TrainingTypeFixture[] = [
  ...
  { templateId: 19, questionType: 'FINAL_CONSONANT_DELETE', responseType: 'SINGLE_CHOICE', activityType: 'sound-manipulation', content: { source: '각', targetAudioText: '가', removableUnits: ['ㄱ', 'ㄴ', 'ㅁ'] }, answer: { answerIndex: 0, result: '가' } },
