...
const trainingTypeMappings = {
  ...
  HANGUL_BATTLE_BASIC: { categoryId: 'phonics', lessonId: 'battle-rabbit' },
  HANGUL_BATTLE_FINAL: { categoryId: 'phonics', lessonId: 'battle-turtle' },
  HANGUL_BATTLE_DOUBLE_FINAL: { categoryId: 'phonics', lessonId: 'battle-ant' },
...
const legacyTemplateTypes: Readonly<Record<number, LearnerTrainingType>> = {
  ...
  35: 'HANGUL_BATTLE_BASIC',
  36: 'HANGUL_BATTLE_FINAL',
  37: 'HANGUL_BATTLE_DOUBLE_FINAL',
}
