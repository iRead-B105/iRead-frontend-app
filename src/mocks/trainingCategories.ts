...
export const trainingCategories: TrainingCategory[] = [
  {
    ...
    lessons: [
      ...
      { id: 'remove-batchim', categoryId: 'phonological-awareness', title: '받침 빼기', description: '받침 소리를 빼서 새 글자를 만들어요.', activityType: 'sound-omit', estimatedMinutes: 10, isReady: true },
      { id: 'sound-split', categoryId: 'phonological-awareness', title: '음절 빼기', description: '낱말에서 소리 하나를 빼고 들은 낱말을 만들어요.', activityType: 'sound-omit', estimatedMinutes: 12, isReady: true },
  ...
  },
  {
    ...
    image: fluencyIcon,
    lessons: [
      { id: 'read-real-words', categoryId: 'fluency', title: '낱말 읽기', description: '낱말을 눈으로 보고 소리 내어 읽어요.', activityType: 'word-reading-grid', estimatedMinutes: 8, isReady: true },
